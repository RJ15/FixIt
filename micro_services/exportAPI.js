...
exports.handler = (event, context, callback) => {
    ...
    connection.connect(function(err) {
        if (err) {
            ...
            var sqlQueryForRemainingPlayers = "SELECT  * FROM players as player WHERE player.id NOT IN (SELECT sea_team_player.player_id FROM seasons_teams_players as sea_team_player)"
